...
async def rimac(context): 
    await context.respond(gymstatus.rimac_status())
...
async def geisel(context): 
    await context.respond(gymstatus.geisel_floor_status(floor=context.options.floor) )
...
async def main_gym(context): 
    await context.respond(gymstatus.main_gym_status())
